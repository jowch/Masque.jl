...
The other manifest term — heatmap/image `values[]` ([§8](08-scaling.md#8-payload-scaling--robustness-to-large-inputs)) — is bounded not by encoding but by *not shipping
...
a quadtree ([§7](07-scope.md#7-v1-scope)).
