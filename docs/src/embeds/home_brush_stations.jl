...
# ╔═╡ c0e10004-0001-4000-8000-000000000001
using Masque, CairoMakie, Markdown

# ╔═╡ c0e10004-0001-4000-8000-000000000002
begin
    samples = [
        (name = "Seattle", lon = -122.3, lat = 47.6, region = "Cascadia"),
        (name = "Portland", lon = -122.7, lat = 45.5, region = "Cascadia"),
        (name = "Eugene", lon = -123.1, lat = 44.1, region = "Cascadia"),
        (name = "Spokane", lon = -117.4, lat = 47.7, region = "Cascadia"),
        (name = "Boise", lon = -116.2, lat = 43.6, region = "Interior"),
        (name = "Salt Lake City", lon = -111.9, lat = 40.8, region = "Interior"),
        (name = "Denver", lon = -105.0, lat = 39.7, region = "Interior"),
        (name = "Las Vegas", lon = -115.1, lat = 36.2, region = "Southwest"),
        (name = "Phoenix", lon = -112.1, lat = 33.4, region = "Southwest"),
        (name = "Tucson", lon = -110.9, lat = 32.2, region = "Southwest"),
        (name = "Albuquerque", lon = -106.6, lat = 35.1, region = "Southwest"),
    ]
    group_color = Dict("Cascadia" => "#3d5a80", "Interior" => "#e07a3d", "Southwest" => "#2a9d8f")
    palette = [group_color[s.region] for s in samples]
    xs = Float64[s.lon for s in samples]
    ys = Float64[s.lat for s in samples]
