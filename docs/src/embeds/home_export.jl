...
# ╔═╡ c0e10003-0001-4000-8000-000000000001
using Masque, CairoMakie

# ╔═╡ c0e10003-0001-4000-8000-000000000002
begin
    boroughs = [
        (
            name = "Manhattan",
            pop = 1_629_054,
            ring = Point2f[(3.5, 4.6), (4.6, 4.6), (4.85, 10.3), (4.0, 10.55), (3.35, 7.4)],
        ),
        (
            name = "Bronx",
            pop = 1_379_942,
            ring = Point2f[(4.05, 10.35), (6.7, 10.15), (7.15, 11.7), (5.7, 12.45), (3.95, 11.7)],
        ),
        (
            name = "Brooklyn",
            pop = 2_590_516,
            ring = Point2f[(3.7, 1.85), (6.55, 1.65), (7.15, 4.55), (5.15, 5.35), (3.6, 4.35)],
        ),
        (
            name = "Queens",
            pop = 2_293_007,
            ring = Point2f[(5.2, 5.15), (9.15, 4.85), (9.35, 9.55), (7.05, 10.25), (5.25, 9.05)],
        ),
        (
            name = "Staten Island",
            pop = 491_133,
            ring = Point2f[(0.55, 0.55), (2.85, 0.35), (3.25, 2.55), (1.95, 3.35), (0.7, 2.25)],
        ),
    ]
    rings = [b.ring for b in boroughs]
    pops = Float64[b.pop for b in boroughs]
    fig = Figure(size = (560, 400))
    ax = Axis(fig[1, 1]; title = "New York City", aspect = DataAspect())
    hidedecorations!(ax)
    hidespines!(ax)
    poly!(ax, rings; color = pops, colormap = :deep, colorrange = (4.0e5, 2.7e6), strokecolor = :white, strokewidth = 2)
...
# ╔═╡ c0e10003-0001-4000-8000-000000000003
